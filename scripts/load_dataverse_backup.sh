...
DESTINATION_DATAVERSE_NAME=fairagro-searchhub-datasets-blue
DESTINATION_DATAVERSE_CONTEXT=garden-419592--km-bonn-prod-external
...
LAST_BACKUP_FILE="DUMPNAME.dump.gz"
...
kubectl port-forward $DATAVERSE_POD_NAME --context $DESTINATION_DATAVERSE_CONTEXT $DATAVERSE_LOCAL_PORT:$DATAVERSE_REMOTE_PORT >/dev/null &
PORT_FORWARD_PID=$!
