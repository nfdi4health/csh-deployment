...
cat $SCRIPT_DIR/etl_jobs.yaml | envsubst '$NAMESPACE $PIPELINE_RUN_NAME $SOURCE $AWS_ENDPOINT_URL $SOURCE_PATH $COLLECTIONS_PATH $ETL_PIPELINE_IMAGE_TAG $DATAVERSE_HOST' | kubectl apply -f -
